...
import FastifySwagger from '../../packages/platform-fastify/middlewares/fastify-swagger';
import { CreateApplication } from '../../packages/common/interfaces/http/http-factory';
